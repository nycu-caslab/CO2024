...
void VSingleCycleCPU___024root___eval_triggers__act(VSingleCycleCPU___024root* vlSelf) {
    ...
    vlSelf->__VactTriggered.at(1U) = ((IData)(vlSelf->SingleCycleCPU__DOT____Vcellinp__m_Control__opcode) 
    ...
    vlSelf->__VactTriggered.at(2U) = (((~ (IData)(vlSelf->clk)) 
                                      ...
                                      | ((~ (IData)(vlSelf->start)) 
                                         & (IData)(vlSelf->__Vtrigrprev__TOP__start)));
    vlSelf->__VactTriggered.at(3U) = (((IData)(vlSelf->SingleCycleCPU__DOT____Vcellinp__m_Control__opcode) 
                                       != (IData)(vlSelf->__Vtrigrprev__TOP__SingleCycleCPU__DOT____Vcellinp__m_Control__opcode)) 
                                      | (vlSelf->SingleCycleCPU__DOT__inst 
                                         != vlSelf->__Vtrigrprev__TOP__SingleCycleCPU__DOT__inst));
    vlSelf->__VactTriggered.at(4U) = ((((IData)(vlSelf->SingleCycleCPU__DOT__ALUCtl) 
                                        != (IData)(vlSelf->__Vtrigrprev__TOP__SingleCycleCPU__DOT__ALUCtl)) 
    ...
    vlSelf->__VactTriggered.at(5U) = ((vlSelf->SingleCycleCPU__DOT__ALUOut 
