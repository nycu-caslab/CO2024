...
void VSingleCycleCPU___024root__trace_chg_sub_0(VSingleCycleCPU___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
        ...
        bufp->chgIData(oldp+34,(vlSelf->SingleCycleCPU__DOT__inst),32);
        bufp->chgBit(oldp+35,(((0x80U > vlSelf->SingleCycleCPU__DOT__pc_o) 
                               & ((IData)(vlSelf->__VdfgTmp_h98940ace__0) 
                                  >> 6U))));
        bufp->chgCData(oldp+36,(((0x80U <= vlSelf->SingleCycleCPU__DOT__pc_o)
                                  ? 0U : (7U & ((IData)(vlSelf->__VdfgTmp_h0374c2a2__0) 
                                                >> 4U)))),3);
        bufp->chgCData(oldp+37,(((0x80U <= vlSelf->SingleCycleCPU__DOT__pc_o)
                                  ? 0U : (0x1fU & (vlSelf->__VdfgTmp_h9594e3d4__0 
                                                   >> 0xfU)))),5);
        bufp->chgCData(oldp+38,(((0x80U <= vlSelf->SingleCycleCPU__DOT__pc_o)
                                  ? 0U : (0x1fU & (vlSelf->__VdfgTmp_he45b3cba__0 
                                                   >> 0x14U)))),5);
        bufp->chgCData(oldp+39,(vlSelf->SingleCycleCPU__DOT____Vcellinp__m_Register__writeReg),5);
    }
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[3U])) {
        bufp->chgCData(oldp+40,(vlSelf->SingleCycleCPU__DOT__ALUOp),2);
        bufp->chgBit(oldp+41,(vlSelf->SingleCycleCPU__DOT__branch));
        bufp->chgBit(oldp+42,(vlSelf->SingleCycleCPU__DOT__memRead));
        bufp->chgBit(oldp+43,(vlSelf->SingleCycleCPU__DOT__memtoReg));
        bufp->chgBit(oldp+44,(vlSelf->SingleCycleCPU__DOT__memWrite));
        bufp->chgBit(oldp+45,(vlSelf->SingleCycleCPU__DOT__ALUSrc));
        bufp->chgBit(oldp+46,(vlSelf->SingleCycleCPU__DOT__regWrite));
        bufp->chgBit(oldp+47,(vlSelf->SingleCycleCPU__DOT__jump));
    }
    bufp->chgBit(oldp+48,(vlSelf->clk));
    bufp->chgBit(oldp+49,(vlSelf->start));
    bufp->chgIData(oldp+50,(vlSelf->t0),32);
    bufp->chgIData(oldp+51,(vlSelf->t1),32);
    bufp->chgIData(oldp+52,(vlSelf->t2),32);
    bufp->chgIData(oldp+53,(vlSelf->t3),32);
    bufp->chgIData(oldp+54,(vlSelf->t4),32);
    bufp->chgIData(oldp+55,(vlSelf->t5),32);
    bufp->chgIData(oldp+56,(vlSelf->t6),32);
    bufp->chgIData(oldp+57,(vlSelf->s0),32);
    bufp->chgIData(oldp+58,(vlSelf->s1),32);
    bufp->chgIData(oldp+59,(vlSelf->s2),32);
    bufp->chgIData(oldp+60,(vlSelf->sp),32);
    bufp->chgIData(oldp+61,(vlSelf->a0),32);
    bufp->chgIData(oldp+62,(vlSelf->a1),32);
    bufp->chgIData(oldp+63,(vlSelf->ra),32);
    bufp->chgIData(oldp+64,(vlSelf->SingleCycleCPU__DOT__pc_i),32);
    bufp->chgIData(oldp+65,(vlSelf->SingleCycleCPU__DOT__pc_aimm),32);
    bufp->chgIData(oldp+66,(vlSelf->SingleCycleCPU__DOT__readData1),32);
    bufp->chgIData(oldp+67,(vlSelf->SingleCycleCPU__DOT__readData2),32);
    bufp->chgIData(oldp+68,(((IData)(vlSelf->SingleCycleCPU__DOT__jump)
                              ? ((IData)(4U) + vlSelf->SingleCycleCPU__DOT__pc_o)
                              : vlSelf->SingleCycleCPU__DOT__memtoRegWriteData)),32);
    bufp->chgIData(oldp+69,(vlSelf->SingleCycleCPU__DOT__imm),32);
    bufp->chgIData(oldp+70,((vlSelf->SingleCycleCPU__DOT__imm 
                             << 1U)),32);
    bufp->chgIData(oldp+71,(vlSelf->SingleCycleCPU__DOT__alu_s2),32);
    bufp->chgCData(oldp+72,(vlSelf->SingleCycleCPU__DOT__ALUCtl),4);
    bufp->chgBit(oldp+73,((1U == vlSelf->SingleCycleCPU__DOT__ALUOut)));
    bufp->chgIData(oldp+74,(vlSelf->SingleCycleCPU__DOT__ALUOut),32);
    bufp->chgIData(oldp+75,(vlSelf->SingleCycleCPU__DOT__memtoRegWriteData),32);
    bufp->chgIData(oldp+76,(vlSelf->SingleCycleCPU__DOT__readData),32);
    bufp->chgCData(oldp+77,(vlSelf->SingleCycleCPU__DOT____Vcellinp__m_Control__opcode),7);
    bufp->chgBit(oldp+78,(vlSelf->SingleCycleCPU__DOT____Vcellinp__m_Mux_PC__sel2));
}
