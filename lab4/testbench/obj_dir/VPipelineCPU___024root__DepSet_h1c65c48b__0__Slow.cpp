...
VL_ATTR_COLD void VPipelineCPU___024root___eval_initial(VPipelineCPU___024root* vlSelf) {
    ...
    vlSelf->__Vtrigrprev__TOP__PipelineCPU__DOT__EXE_alu_s1 
        = vlSelf->PipelineCPU__DOT__EXE_alu_s1;
    vlSelf->__Vtrigrprev__TOP__PipelineCPU__DOT__EXE_alus2_imm 
...
VL_ATTR_COLD void VPipelineCPU___024root___dump_triggers__act(VPipelineCPU___024root* vlSelf) {
    ...
    if (vlSelf->__VactTriggered.at(5U)) {
        VL_DBG_MSGF("         'act' region trigger index 5 is active: @([changed] PipelineCPU.EXE_ALUCtl or [changed] PipelineCPU.EXE_alu_s1 or [changed] PipelineCPU.EXE_alus2_imm)\n");
    }
...
VL_ATTR_COLD void VPipelineCPU___024root___dump_triggers__nba(VPipelineCPU___024root* vlSelf) {
    ...
    if (vlSelf->__VnbaTriggered.at(5U)) {
        VL_DBG_MSGF("         'nba' region trigger index 5 is active: @([changed] PipelineCPU.EXE_ALUCtl or [changed] PipelineCPU.EXE_alu_s1 or [changed] PipelineCPU.EXE_alus2_imm)\n");
    }
...
VL_ATTR_COLD void VPipelineCPU___024root___ctor_var_reset(VPipelineCPU___024root* vlSelf) {
    ...
    vlSelf->PipelineCPU__DOT__IF_ID_flush = VL_RAND_RESET_I(1);
    vlSelf->PipelineCPU__DOT__ID_EX_flush = VL_RAND_RESET_I(1);
    vlSelf->PipelineCPU__DOT__EXE_alu_s1 = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__EXE_alu_s2 = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__EXE_alus2_imm = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT____Vcellinp__hazardDectionUnit__branchTake = VL_RAND_RESET_I(1);
    ...
    vlSelf->PipelineCPU__DOT____Vcellout__EXE_MEM_control_reg__o = VL_RAND_RESET_I(5);
    ...
    VL_RAND_RESET_W(96, vlSelf->__Vdly__PipelineCPU__DOT____Vcellout__IF_ID_reg__o);
    ...
    vlSelf->__Vtrigrprev__TOP__PipelineCPU__DOT__EXE_alu_s1 = VL_RAND_RESET_I(32);
    vlSelf->__Vtrigrprev__TOP__PipelineCPU__DOT__EXE_alus2_imm = VL_RAND_RESET_I(32);
