...
wire [31:0] EXE_imm_sl, EXE_pc_aimm, EXE_alu_s2, EXE_ALUOut;
wire [3:0] EXE_ALUCtl;
wire EXE_condition;

// MEM wire
wire [31:0] MEM_ALUOut, MEM_readData2, MEM_inst, MEM_pc_a4;
wire MEM_branch, MEM_memRead, MEM_memtoReg, MEM_memWrite, MEM_regWrite, MEM_jump;
wire MEM_condition;
...
Mux4to1 #(.size(32)) PC_Mux(
    .sel1(MEM_jump),
    .sel2(((~MEM_jump)&MEM_branch&MEM_condition)|(MEM_jump&MEM_branch)),
    .s0(pc_a4),
    .s1(EXE_pc_aimm),
    .s2(EXE_pc_aimm),
    .s3(EXE_ALUOut),
...
PipeReg #(.size(7)) EXE_MEM_control_reg(
    .clk(clk),
    .rst(start),
    .i({EXE_branch, EXE_memRead, EXE_memtoReg, EXE_memWrite, EXE_regWrite, EXE_jump, EXE_condition}),
    .o({MEM_branch, MEM_memRead, MEM_memtoReg, MEM_memWrite, MEM_regWrite, MEM_jump, MEM_condition})
);

PipeReg #(.size(128)) EXE_MEM_reg(
    .clk(clk),
    .rst(start),
    .i({EXE_ALUOut, EXE_readData2, EXE_inst, EXE_pc_a4}),
    .o({MEM_ALUOut, MEM_readData2, MEM_inst, MEM_pc_a4})
);
